...
public class DeclarPassport extends AbstractModel implements Serializable,Cloneable {
	...
	public List<Object> getAll() {	
		...
		listValue.add(getDp_first_name());
		listValue.add(getDp_second_name());	
		listValue.add(getDp_date_birth());
		listValue.add(getDp_passport_nb());
		listValue.add(getDp_password_indent_nb());		
		listValue.add(getDp_passport_valid_data());		
		return listValue;
	}
